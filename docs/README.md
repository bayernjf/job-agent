...
| 针对岗位生成定制简历（已落地 P-R1/P-R2 + P-R3 可闭环子项：resume-core 纯函数 + polish 安全层、CLI build/batch、POST /resumes/build、报告页 ResumeBuilder、扩展深链；真实 LLM/服务端持久化/PDF/版本管理待拍板，见 handoff item18） | [design-targeted-resume-20260915.md](design-targeted-resume-20260915.md) ★ |

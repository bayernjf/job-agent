...
```bash
EXTENSION_API_BASE=https://<app-origin>/api EXTENSION_SITE_ORIGIN=https://<app-origin> \
  pnpm --filter @jobagent/extension release   # 产出 apps/extension/release/*.zip
```
